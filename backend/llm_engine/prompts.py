...
- For "deep_focus", "light_focus", or "creative_flow": start with alpha (8-12 Hz), transition to beta (12-30 Hz), wind down
- For "calm": transition from alpha (8-12 Hz) down to theta (4-8 Hz)
- For "sleep_aid": progress from theta (4-8 Hz) to delta (0.5-4 Hz)
